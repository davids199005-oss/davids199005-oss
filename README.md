...
Book catalog, EPUB/PDF reader, RAG-based AI chat over book content, real-time streaming, OAuth, admin panel.

`NestJS 11` `Angular 21` `PostgreSQL` `pgvector` `TypeORM` `OpenAI` `RAG` `Socket.IO` `JWT` `OAuth` `PrimeNG` `Tailwind CSS`

</td>
<td width="50%" valign="top">

### ✈️ [Vacanza](https://github.com/davids199005-oss/Vacanza)
**Full-Stack Travel Platform**

Vacation booking with AI recommendations via GPT-4o-mini, MCP server integration, admin panel with charts & CSV export. Dockerized with Nginx reverse proxy.

`React 19` `Express 5` `MySQL` `Redux` `Zod` `Ant Design` `OpenAI` `MCP` `Docker` `Nginx` `JWT`
...
### 📊 [CryptoGraph](https://github.com/davids199005-oss/CryptoGraph)
**Crypto Analytics Dashboard** · [Live Demo](https://davids199005-oss.github.io/CryptoGraph/)

Real-time market data, coin details, chart-based reports, AI-powered buy/sell recommendations.
